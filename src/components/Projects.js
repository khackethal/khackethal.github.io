...
function Projects() {
  ...
  const items = [ 
    ...
    { id: 2, title: 'MemoryMap' , image: '', header: 'Group project 3 ppl - 1 week',
      description: 'We chose to create an app that lets users upload their favourite memories, tagging them on a map, creating an alternative travel guide. Our Frontend was built using React, and the Backend using Express, Mongoose and MongoDB. I was responsible for setting up the repository on GitHub, and the overall file structure for both Frontend and Backend. I then wrote the logic for displaying an index page, a second version of the index integrating mapbox, the single memory display page, the edit and remove functions for memories as well as the add and remove functions for comments. In the backend I worked on the comment controller, and kept all models updated.' },
                  ...
                  <div className="card-div">
                    ...
                    <div id="description-div">
                      <div id="inner-description-div">
                        ...
                        <h3 id="card-subtitle">{item.header}</h3>
                        {item.description} 
                      </div>
                      <div className="button-div">
                        <button id="contact-button-2"><a className="card-link" href="http://www.google.com">Go to site</a></button>
                        <br/>
                        <button id="contact-button-2"><a className="card-link" >Go to GitHub</a></button>
                      </div>
                    </div>
                  </div>
                </div>
